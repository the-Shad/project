...
<div class="container" style="width: 95%;">
	...
	<div class="card" style="margin: 10px">
		...
		<div class="card-body">
			<form action="/tutor/edit/question" method="POST">
				<input value="${QUESTION.id}" name="question_id" hidden="true">
				<label>
					<p:message key="tutor.page.question" />
				</label>
				<br>
				<input type="text" value="${QUESTION.question}" class="form-control" style="width: 100%;" name="question_question">
				<br>
				<input value="${TEST.id}" name="test_id" hidden="true">
			...
			<form action="/tutor/edit/answers" method="GET">
				...
				<button type="submit" class="btn btn-primary" style="margin: 10px">
					<p:message key="tutor.page.editAnswers" />
				</button>
			</form>
		</div>
